...
if __name__ == "__main__":
    ...
    generated_images_saliency_maps = Path("/home/igragon/Projects/innopolis_thesis_2025/EEG-Salience-Image/evals/sith-midichlorian-176-controlnet-27-guidance-2_saliency_maps")
    ...
    for gt_smap, recon_smap in zip(all_images, all_brain_recons):
        ...
        KL_scores.append(image_based_kl_divergence(recon_smap, gt_smap))
